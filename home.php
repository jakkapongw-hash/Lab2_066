	...
	<table width="1238" height="530" border="0">
		...
		<tr>
			...
			<td width="190" bgcolor="#FFFF66"><ul>
				<li><a href="home.php">หน้าแรกจร้าาาาาาาาาาาา</li>
				<li><a href="room.php">ห้องพัก&ราคา 000 000 000 000 000 000 </li>
				<li><a herf="guest.php">สมุดเยี่ยมม</li>
				<li><a href="contact.php">ติดต่อคับ</li>
				</ul><p>
